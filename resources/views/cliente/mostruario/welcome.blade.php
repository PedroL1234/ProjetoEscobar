                ...
                <div class="col-lg-4">
                    <div class="item">
                        <div class="thumb">
                            ...
                            <img  class="foto_vitrine" src="assets/images/women-01.jpg"  alt="">
                        </div>
                        <div class="down-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('clientes.salvar') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="telefone">
                        <div id="emailHelp" class="form-text">Digite seu numero de telefone(***)****</div>
                      </div>
